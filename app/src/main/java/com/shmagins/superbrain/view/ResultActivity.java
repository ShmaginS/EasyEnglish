...
import com.shmagins.superbrain.databinding.ActivityResultBinding;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        List<String> solved = FormatUtils.convertCalculationsToStringList(this, game.getSolved(), game);
        List<String> failed = FormatUtils.convertCalculationsToStringList(this, game.getFailed(), game);
...
//                <string name="game_summary">Правильных ответов: %d из %d\nзатраченное время: %d:%d</string>
